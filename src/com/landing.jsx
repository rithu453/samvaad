...
//           <p className="mt-2 text-gray-600">Prepare for your upcoming interviews with guided practice</p>
//         </div>
...
//           <button 
//             className="w-full flex justify-center py-3 px-4 border border-gray-300 rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150"
...
//           <p className="text-sm text-gray-500">Practice makes perfect. Start your journey today!</p>
//         </div>
//       </div>
//     </div>
//   );
